"""
This script is to generate image of veh-edge collision with json files (scenarios) generated by CtRL-Sim.
The input should be json format files generated by ctrl-sim
Paramters to set: path (path of input files (folder)), save_dir (path of output)
"""
...
save_dir='./edge_collision_1000'       # output folder
